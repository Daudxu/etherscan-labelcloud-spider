...
s = Service(r"E:/webroot/etherscan-labelcloud-spider/h/chromedriver.exe")
...
try:
   ...
   url = "https://etherscan.io/accounts/label/uniswap?subcatid=0&size=10000&start=90000&col=1&order=asc"
