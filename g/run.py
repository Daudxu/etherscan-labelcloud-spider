...
s = Service(r"E:/webroot/etherscan-labelcloud-spider/g/chromedriver.exe")
...
try:
   ...
   url = "https://etherscan.io/accounts/label/uniswap?subcatid=0&size=10000&start=80000&col=1&order=asc"
